                ...
                <div class="overflow-x-auto">
                    <table class="min-w-full divide-y divide-line">
                        <thead class="bg-paper">
                            <tr>
                                <th class="px-4 py-3 text-left text-xs font-semibold uppercase tracking-wider text-ink-soft/70">Cerere</th>
                                ...
                                <th class="px-4 py-3 text-left text-xs font-semibold uppercase tracking-wider text-ink-soft/70">Trimisă</th>
                            ...
                            >
                                <td class="px-4 py-3">
                                    <div class="flex items-center gap-3">
                                        <span class="flex items-center justify-center w-9 h-9 rounded-xl bg-paper flex-none">
                                            <MessageSquareText class="w-4 h-4 text-ink-soft/50" />
                                        </span>
                                        <div class="min-w-0">
                                            <p class="text-sm font-semibold text-ink truncate">{{ quoteRequest.title }}</p>
                                            <p class="text-xs text-ink-soft">{{ quoteRequest.category ?? '—' }}</p>
                                        </div>
                                    </div>
                                </td>
                                <td class="px-4 py-3 text-sm">
                                    <p class="text-ink">{{ quoteRequest.name }}</p>
                                    <p class="text-xs text-ink-soft">{{ quoteRequest.email }}</p>
                                </td>
                                ...
                                <td class="px-4 py-3 text-sm text-ink-soft whitespace-nowrap">{{ quoteRequest.created_at }}</td>
